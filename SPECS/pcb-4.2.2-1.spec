...
#
# Copyright (c) 2017, 2018, 2019, 2020 Bert Timmerman <bert.timmerman@xs4all.nl>
#
...
%changelog
* Sun May 31 2020 bert.timmerman@xs4all.nl
- first spec file for release 4.2.2.

* Tue Dec 31 2019 bert.timmerman@xs4all.nl
- first spec file for release 4.2.1.

* Sat Feb 2 2019 bert.timmerman@xs4all.nl
- first spec file for release 4.2.0.

* Wed Oct 3 2018 bert.timmerman@xs4all.nl
- first spec file for release 4.1.3.

* Sun May 13 2018 bert.timmerman@xs4all.nl
- first spec file for release 4.1.2.
